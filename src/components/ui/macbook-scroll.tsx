...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-75 lg:scale-90 xl:scale-100 md:py-80"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px] w-[32rem]">
      <div
        style={{
        ...
        className="relative h-[12rem] w-full rounded-2xl p-2"
      >
        <div
          style={{
